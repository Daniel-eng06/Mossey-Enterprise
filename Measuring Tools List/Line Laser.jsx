...
import "./Line Laser.css";
import Header from "../Header&Nav/Header&Nav.jsx";
import Footer from "../Footer/Footer.jsx";
import {linelaser} from "./Measuring Data.jsx";
        ...
        <div>
            ...
            <div className="mpage1">
                <div className="lbody1">
                    <p id="act" > <Link to="/">Home {">"}</Link> <Link to="/Measuring Tools"> Measuring Tools {">"} </Link> <span id="act1">Line Laser</span> </p>
                </div>
