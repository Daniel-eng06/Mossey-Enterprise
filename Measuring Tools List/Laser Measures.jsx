...
import "./Laser Measures.css";
import Header from "../Header&Nav/Header&Nav.jsx";
import Footer from "../Footer/Footer.jsx";
import {lasermea} from "./Measuring Data.jsx";
    ...
    return(
        <div>
            ...
            <div className="mpage1">
                <div className="labody1">
                    <p id="act" > <Link to="/">Home {">"}</Link> <Link to="/Measuring Tools"> Measuring Tools {">"} </Link><span id="act1">Laser Measures</span> </p>
                </div>
