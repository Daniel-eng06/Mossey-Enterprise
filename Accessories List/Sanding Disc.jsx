...
import "./Sanding Disc.css";
import Header from "../Header&Nav/Header&Nav.jsx";
import Footer from "../Footer/Footer.jsx";
import {sandisc} from "./Accessories data.jsx";
...
function SandingDisc(){
    ...
    return(
        <div>
            <Header/>
            <div className="sanpage">
                <div className="drbody">
                    <p id="act" ><Link to="/">Home {">"}</Link> <Link to="/Accessories"> Accessories {">"}</Link>  <span id="act1">Sanding Disc</span></p>
                </div>
