...
import "./Drill Bits.css";
import Header from "../Header&Nav/Header&Nav.jsx";
import Footer from "../Footer/Footer.jsx";
import {drillbits} from "./Accessories data.jsx";
        ...
        <div>
            ...
            <div className="drpage">
                <div className="drbody">
                    <p id="act" ><Link to="/">Home {">"}</Link> <Link to="/Accessories"> Accessories {">"}</Link>  <span id="act1">Drill Bits</span></p>
                </div>
