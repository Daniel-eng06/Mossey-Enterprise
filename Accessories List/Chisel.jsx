...
import {chisel} from "./Accessories data.jsx";
...
function Chisels(){
    ...
    return(
        <div>
            <Header/>
            <div className="chipage">
                <div className="drbody">
                    <p id="act" ><Link to="/">Home {">"}</Link> <Link to="/Accessories"> Accessories {">"}</Link> <span id="act1">Chisels</span></p>
                </div>
