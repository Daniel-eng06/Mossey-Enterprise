...
import {disc} from "./Accessories data.jsx";
...
function DiamondDisc(){
    ...
    return(
        <div>
            <Header/>
            <div className="drpage1">
                <div className="drbody">
                    <p id="act" > <Link to="/">Home {">"}</Link> <Link to="/Accessories"> Accessories {">"}</Link>  <span id="act1">Diamond Disc</span></p>
                </div>
