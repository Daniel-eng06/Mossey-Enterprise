...
import "./Saw Blades.css";
import Header from "../Header&Nav/Header&Nav.jsx";
import Footer from "../Footer/Footer.jsx";
import {sawblade} from "./Accessories data.jsx";
        ...
        <div>
            ...
            <div className="sapage">
                <div className="drbody">
                    <p id="act" > <Link to="/">Home {">"}</Link> <Link to="/Accessories"> Accessories {">"}</Link>  <span id="act1">Saw Blades</span></p>
                </div>
