        ...
        <div>
            ...
            <div className="clopage">
                <div className="clobody">
                    <p id="act" > <Link to="/">Home {">"}</Link> <Link to="/Safety Wears & Equipments"> Safety Wears {">"} </Link><span id="act1">Boots</span> </p>
                </div>
