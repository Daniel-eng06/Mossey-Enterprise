        ...
        <div>
            ...
            <div className="clopage">
                <div className="clobody">
                    <p id="act" > <Link to="/">Home {">"}</Link> <Link to="/Safety Wears & Equipments">Equipments {">"}</Link> <span id="act1">Door Locks</span> </p>
                </div>
...
export default SecurityPadlock;