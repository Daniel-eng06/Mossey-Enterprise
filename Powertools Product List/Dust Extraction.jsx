...
import {dust} from "./Powertools data.jsx";
...
function Extractor(){
    ...
    return(
        <div>
            <Header/>
            <div className="cpage6">
                <div className="dbody1">
                    <p id="act" ><Link to="/">Home {">"}</Link> <Link to="/Powertools">Power Tools {">"}</Link><span id="act1">Dust Systems</span> </p>
                </div>
