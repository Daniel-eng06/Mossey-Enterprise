...
import {routers} from "./Powertools data.jsx";
...
function Routers(){
    ...
    return(
        <div>
            <Header/>
            <div className="cpage8">
                <div className="roubody1">
                    <p id="act" ><Link to="/">Home {">"}</Link> <Link to="/Powertools"> Power Tools {">"}</Link> <span id="act1">Routers</span> </p>
                </div>
