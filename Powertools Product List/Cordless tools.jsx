...
import "./Cordless tools.css";
import Header from "../Header&Nav/Header&Nav.jsx";
import Footer from "../Footer/Footer.jsx";
import {cordless} from "./Powertools data.jsx";
import {Link} from "react-router-dom";
import ChatButton from "./WhatsApp.jsx";
...
function Cordless(){
    ...
    return(
        <div>
            ...
            <div className="cpage">
                <div className="pbody">
                    <p id="act" ><Link to="/">Home {">"}</Link> <Link to="/Powertools"> Power Tools {">"}</Link>  <span id="act1">Cordless Tools</span> </p>
                </div>
