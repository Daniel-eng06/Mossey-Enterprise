...
import {saws} from "./Powertools data.jsx";
...
function Saws(){
    ...
    return(
        <div>
            <Header/>
            <div className="cpage10">
                <div className="sawbody1">
                    <p id="act" ><Link to="/">Home {">"}</Link> <Link to="/Powertools"> Power Tools {">"}</Link><span id="act1">Saws</span> </p>
                </div>
