...
import {benchtool} from "./Powertools data.jsx";
...
function BenchTop(){
    ...
    return(
        <div>
            <Header/>
            <div className="cpage5">
                <div className="bbody1">
                    <p id="act" ><Link to="/">Home {">"}</Link> <Link to="/Powertools"> Power Tools {">"}</Link><span id="act1">Benchtop</span> </p>
                </div>
