...
import {heatguns} from "./Powertools data.jsx";
...
function HeatGun(){
    ...
    return(
        <div>
            <Header/>
            <div className="cpage7">
                <div className="hbody1">
                    <p id="act" ><Link to="/">Home {">"}</Link> <Link to="/Powertools"> Power Tools {">"}</Link> <span id="act1">Heat Guns</span> </p>
                </div>
