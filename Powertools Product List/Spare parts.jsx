...
import {spare} from "./Powertools data.jsx";
...
function SparePart(){
    ...
    return(
        <div>
            <Header/>
            <div className="cpage11">
                <div className="spbody1">
                    <p id="act" ><Link to="/">Home {">"}</Link> <Link to="/Powertools"> Power Tools {">"}</Link> <span id="act1">Spare Parts</span> </p>
                </div>
